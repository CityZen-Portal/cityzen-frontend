...
import CustomCalendar from "./cards/CustomerCalendar";
          ...
          <button
            ...
            className={`flex h-8 w-8 items-center justify-center rounded px-2 py-1 ${
              currentPage === num
                ...
                : "bg-gray-100 hover:bg-gray-300 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
            }`}
          >
            {num}
          </button>
...
export default function AdminDashboard() {
  ...
  const cardStyle =
    "rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-md transition-colors";
              ...
              <div className="col-span-2 rounded-2xl bg-white p-6 shadow-lg transition-colors dark:bg-gray-800">
                ...
                <table className="w-full text-sm">
                  <colgroup>
                    ...
                    <col className="w-[35%]" />{" "}
                    {/* Status column - 35% width */}
                    <col className="w-[25%]" />{" "}
                    {/* Date column - 25% width (reduced) */}
                  </colgroup>
                  <thead>
                    <tr className="text-black text-left dark:text-gray-300">
                      <th className="pb-2 pr-2">Name</th>{" "}
                      {/* Added pr-2 for right padding */}
