...
const SignupCitizen = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-12 
      ...
      {/* SignUp Card */}
      <div className="relative z-10 w-full max-w-xl p-8 rounded-2xl shadow-2xl 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-3 border rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-[#422afb] ${
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-3 pr-10 border rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-[#422afb] ${
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className={`flex-1 px-3 py-3 border rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-[#422afb] ${
