const initialRequests = [
  ...
  { id: 5, citizenName: "John Doe", service: "Garbage Overflow", status: "pending", date: "2023-06-16", description: "Garbage bin overflowing at 5th Avenue" },
  { id: 6, citizenName: "Jane Smith", service: "Park Maintenance", status: "pending", date: "2023-06-19", description: "Broken benches and unclean area in Central Park" },
  ...
  { id: 9, citizenName: "John Doe", service: "Water Leakage", status: "completed", date: "2023-06-20", description: "Leaking pipe on Maple Street" },
  { id: 10, citizenName: "Jane Smith", service: "Tree Trimming", status: "pending", date: "2023-06-18", description: "Branches near power lines" },
  ...
  { id: 13, citizenName: "John Doe", service: "Sewage Blockage", status: "pending", date: "2023-06-22", description: "Manhole blocked at Oak Lane" },
  { id: 14, citizenName: "Jane Smith", service: "Noise Complaint", status: "pending", date: "2023-06-23", description: "Loud construction work at night" },
